                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="page-title-box">
                                    ...
                                    <h4 class="page-title">Modifier cette salle</h4>
                                </div>
                            </div>
                        </div>
                        <!-- end page title -->
                            ...
                            <div class="col-6">
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <form method="POST" action="{{ route('salles.update', $salle->id_annee) }}">
                                            @csrf
                                            @method('PUT')
                                            ...
                                            <div class="form-row">
                                                <div class="form-group col-md-12">
                                                    ...
                                                    <input type="text" class="form-control" name="nom" value="{{ old('nom') ?? $salle->nom }}">
                                                </div>
