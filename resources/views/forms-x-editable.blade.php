...
@section('css')
        <!-- Plugins css -->
        <link href="{{ URL::asset('assets/libs/x-editable/x-editable.min.css')}}" rel="stylesheet" type="text/css" />
@endsection
...
@section('script')
        ...
        <script src="{{ URL::asset('assets/libs/x-editable/x-editable.min.js')}}"></script>
