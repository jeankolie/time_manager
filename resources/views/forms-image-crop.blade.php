...
@section('css')
        <!-- Cropper css -->
        <link href="{{ URL::asset('assets/libs/cropper/cropper.min.css')}}" rel="stylesheet" type="text/css" />
@endsection
...
@section('script')
        ...
        <!-- Init js-->
        <script src="{{ URL::asset('assets/js/pages/form-imagecrop.init.js')}}"></script>
